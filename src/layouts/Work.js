        ...
        <div className='work-container wmd'>
            ...
            <div className='work-right'>
                ...
                <ul className='right-list'>
                    <li className='right-list-li'>Worked on multiple projects for clients across different industries, including marketing, communication, and finance, under the guidance of senior developers such as 
                    <a href='https://www.publicisgroupe.com/en/the-groupe/about-publicis-groupe' target="_blank" rel="noopener noreferrer" className='desc-link'> <span>Publicis Groupe</span></a> and a project for <a href='https://unity-bars.com/en/products/b-one' target="_blank" rel="noopener noreferrer" className='desc-link'> <span>B.One</span></a>.</li>
